...
SatMsg::SatMsg(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->hopCount = 0;
}

SatMsg::SatMsg(const SatMsg& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
const char * SatMsg::getSource() const
{
    return this->source.c_str();
}

void SatMsg::setSource(const char * source)
{
    this->source = source;
}

const char * SatMsg::getDestination() const
{
    return this->destination.c_str();
}

void SatMsg::setDestination(const char * destination)
{
    this->destination = destination;
}

int SatMsg::getHopCount() const
{
    return this->hopCount;
}

void SatMsg::setHopCount(int hopCount)
{
...
SatMsgDescriptor::SatMsgDescriptor() : omnetpp::cClassDescriptor("SatMsg", "omnetpp::cPacket")
{
